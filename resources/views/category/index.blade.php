...
@section('content')
    ...
    <div id="editModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <form method="POST" action='{{ route('category.update') }}' class="modal-content">
                @csrf
                @method('PATCH')
    ...
    <div id="deleteModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <form method="POST" action='{{ route('category.destroy') }}' class="modal-content">
                @csrf
                @method('DELETE')
                <div class="modal-header">
    ...
    <div id="addModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <form method="POST" action='{{ route('category.add') }}' class="modal-content">
                @csrf
                @method('POST')
              <div class="modal-header">
